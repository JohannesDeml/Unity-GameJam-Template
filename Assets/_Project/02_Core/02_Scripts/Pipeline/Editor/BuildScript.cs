...
namespace UnityBuilderAction
{
	...
	/// Supports logging in the editor and using custom tag data to alter the build
		...
		public static void Build(string[] args)
		{
			...
			switch (buildTarget)
			{
				...
				case BuildTarget.WebGL:
					...
					{
						PlayerSettings.WebGL.template = tagParameters.Contains("debug") ? "PROJECT:Develop" : "PROJECT:Release";
					}
					break;
			}
			...
			if (tagParameters != null)
			{
				if (tagParameters.Contains("debug"))
				{
